...
(function() {
	...
	var webuse = ["fewer than 5", "5 to 10", "10 to 20", "20 to 50", "more than 50"];
	
	var jqElBackgr = $("#educationalBackground");
	if(jqElBackgr.length){
	...
	$("#webuse").html(ap.utilDom.createRadioButtonScaleElement(false, "webuse", webuse.length, webuse));
	$("#designExperience").html(ap.utilDom.createRadioButtonScaleElement(true, "designExperience", 5, null, ["No experience", "Advanced"]));
	$("#englishProficiency").html(ap.utilDom.createRadioButtonScaleElement(true, "englishProficiency", 5, null, ["Basic", "Advanced"]));
