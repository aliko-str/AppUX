...
var Console = function(sessionId, _moduleName) {
	var moduleName = _moduleName || "";
	sessionId = sessionId.toString();
	var ss = require("./storage.js").getStorage(sessionId);
	// ss = ss.getStorage(sessionId);
	var infoLog = ss.registerOutput("infoLog", true);
	var errorLog = ss.registerOutput("errorLog", true);
	var _log = function(ifErr, str, errCode) {
