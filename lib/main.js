...
var questions = require("./resources/questions.js");
...
function _init() {
	...
	allModules["rateWebsAestheticsModule"] = new WebsiteRatingModule(props, questions["website.aesthetics"], googleWebsites);
	allModules["rateCompanyEmplModule"] = new WebsiteRatingModule(props, questions["company.image.as.employer"], googleWebsites);
