...
var settings = require("./resources/_settings.js");

var GoogleModule = function(props, websitesToStudy) {
	var minTimeToBrowse = props.debug?5:settings.getGoogleExperienceDurationInSeconds(); // seconds
	var browsingTracker, clickingTracker, lookingTimeTracker;
	// EXPERIMENTAL //
	// var loadingTimeTracker = new (require("./tracker.loading.time.js").LoadTimeTracker)(props, "google.experience", websitesToStudy);
	// loadingTimeTracker.activate();
	// end EXPERIMENTAL //
