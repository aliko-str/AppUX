...
var GoogleModule = function(props, websitesToStudy) {
	var browsingTracker = new (require("./tracker.visit.revisit.js").BrowsingTracker)(props, "*", websitesToStudy);
	var clickingTracker = new (require("./tracker.clicks.js").ClickTracker)(props, "*", websitesToStudy);
	var inits = {
