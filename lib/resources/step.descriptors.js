...
var _steps = {
	...
	"webpage.aesthetics.150": {
		title: "Immediate-impression evaluation",
		text: "In each trial: <br/> 1. look at the middle of red fixation cross (!important) <br/> 2. watch a webpage screenshot being briefly flashed on the screen <br/> 3. rate webpage aesthetics <br/><br/> NOTE: first 3 trials are training trials"
	},
	"webpage.aesthetics.4": {
		title: "Deliberate-impression evaluation",
		text: "In each trial: <br/> 1. explore a webpage screenshot for at least 4 sec <br/> 2. rate webpage aesthetics <br/><br/> NOTE: you can scroll down the screenshots"
	},
	"google.experience": {
	...
	"tasks.and.ratings" :{
		...
		text : "For each website: <br/> 1. Search info on a website to answer 3 questions <br/> 2. Rate a company and their website <br/><br/> NOTE: some websites don't show all required info"
	},
	"free.text.descriptions": {
		title: "Free-text company-preference description",
		text : "Describe briefly the reasons you preferred one company and disliked the other."
	}
};
