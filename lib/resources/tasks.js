...
var tasks = {
	...
	"best.website.free.description" : {
		...
		text : "You've ranked this company and their website as the best. Please write 3 or more short phrases explaining why you decided so (use semicolons to split the phrases).",
		saveName : "data.task.best.website.description"
	},
	"worst.website.free.description" : {
		id : "worst.website.free.description",
		text : "You've ranked this company and their website as the worst. Please write 3 or more short phrases explaining why you decided so (use semicolons to split the phrases).",
