...
var tasks = {
	...
	"best.website.free.description" : {
		...
		text : "You've ranked this company as <strong>the most</strong> desirable place for your internship. Please write 3 or more short phrases explaining why you decided so (<span style='color:#7F0906;'>use semicolons to split the phrases</span>).",
		saveName : "data.task.best.website.description"
	},
	"worst.website.free.description" : {
		id : "worst.website.free.description",
		text : "You've ranked this company as <strong>the least</strong> desirable place for your internship. Please write 3 or more short phrases explaining why you decided so (<span style='color:#7F0906;'>use semicolons to split the phrases</span>).",
